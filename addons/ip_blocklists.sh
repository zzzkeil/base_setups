...
echo -e " ${GRAYB}#${ENDCOLOR} ${YELLOW}Blocklist URL = ??? https://www.darklist.de/iptables.php                  ${ENDCOLOR}${GRAYB}#${ENDCOLOR}"
echo -e " ${GRAYB}#${ENDCOLOR} ${YELLOW}Autoupdate list and blocks every day                                      ${ENDCOLOR}${GRAYB}#${ENDCOLOR}"
echo -e " ${GRAYB}##############################################################################${ENDCOLOR}"
